...
$null = $sb.AppendLine("    BulletCollision/  # Bullet Physics headers")
$null = $sb.AppendLine("    BulletDynamics/   # Bullet Physics headers")
$null = $sb.AppendLine("    LinearMath/       # Bullet Physics headers")
